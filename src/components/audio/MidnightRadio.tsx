...
import { Volume2, VolumeX, Disc3, Radio, Sparkles } from "lucide-react";
            ...
            <div className="flex items-end gap-[2px] h-3.5 w-3.5">
              <span
                className={`w-[2px] bg-white transition-all duration-300 ${
                  isPlaying ? "h-full animate-[bounce_0.8s_ease-in-out_infinite]" : "h-1 bg-zinc-500"
                }`}
              />
              <span
                className={`w-[2px] bg-white transition-all duration-300 ${
                  isPlaying ? "h-2/3 animate-[bounce_0.6s_ease-in-out_infinite_0.2s]" : "h-2 bg-zinc-500"
                }`}
              />
              <span
                className={`w-[2px] bg-white transition-all duration-300 ${
                  isPlaying ? "h-4/5 animate-[bounce_0.9s_ease-in-out_infinite_0.4s]" : "h-1 bg-zinc-500"
                }`}
              />
            </div>
